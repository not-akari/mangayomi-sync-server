...
-- CreateEnum
CREATE TYPE "AuditAction" AS ENUM ('USER_REGISTERED', 'USER_LOGIN', 'INVITE_CREATED', 'INVITE_REVOKED', 'ROLE_CHANGED', 'SETTINGS_CHANGED', 'PASSWORD_CHANGED', 'ACCOUNT_DELETED', 'ACCOUNT_SUSPENDED', 'ACCOUNT_REINSTATED', 'PASSWORD_RESET_LINK_CREATED', 'PASSWORD_RESET_REQUESTED', 'PASSWORD_RESET_COMPLETED', 'EMAIL_CHANGED', 'AVATAR_CHANGED', 'REPORT_CREATED', 'REPORT_STATUS_CHANGED', 'REPORT_REPLY_CREATED', 'SESSION_REVOKED', 'CATALOG_NSFW_OVERRIDE_SET', 'CATALOG_NSFW_BULK_OVERRIDE_SET', 'TOTP_ENABLED', 'TOTP_DISABLED', 'TOTP_RECOVERY_CODE_USED');
